...
{
protected:
double attack; //init val 5
double health; //init val 2
double bleedIntensity; //init val 0
...
void setBleedIntensity(double); //Mage can use mana to combat the RoamingDemon.
double getBleedIntensity(); //affects RoamingDemon.
